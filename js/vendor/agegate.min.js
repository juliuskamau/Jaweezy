...
(function ($) {
  var AG_NAMESPACE = 'ageGate',
      ...
      defaults = {
        logo: 'http://store.thewineshop.com/sites/all/themes/wineshop/logo.png',
        lang: 'en',
        min_age: 18,
        age_span: 100,
      ...
      init: function (age_gate) {
          ...
          return this.each(function () {
              ...
              function buildHTML() {
                  ...
                  var select_day = '<div class="large-4 small-12 medium-4 column center"><select name="age-day" class="age-dob form-control">' + days + '</select></div>';
                  // Months selector
